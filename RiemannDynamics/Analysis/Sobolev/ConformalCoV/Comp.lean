...
/-!
# Weak directional derivatives under conformal change of variables

Precomposition with a conformal map transports weak directional derivatives:
the chain rule for the weak Wirtinger data of a Sobolev function under a
holomorphic change of variables between open sets.

* `hasWeakDirDeriv_comp_conformal` — the conformal chain rule.
-/
